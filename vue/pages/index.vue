<template>
  <section class="container-fluid">
    <div class="row">
      <div class="col-md-6 col-md-offset-3 margin_auto">
        <div class="row">
        ...
        <h1 class="text-center padding_top_bot_20">Welcome to the Boston police</h1>
        <div class="panel panel-login">
          <div class="panel-heading">
            <div class="row">
              <div class="col-md-6 hr_login padding_10">
                <a id="login-form-link"
                   href="#"
                   class="active">Login
                </a>
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <form id="login-form"
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-8 col-sm-offset-3 margin_auto">
